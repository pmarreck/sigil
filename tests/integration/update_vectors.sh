...
for n in manifest_rollback manifest_equivocation manifest_updater_too_old manifest_windows_installed manifest_windows_missing_installed manifest_windows_package; do
